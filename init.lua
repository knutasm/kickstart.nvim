...
vim.keymap.set('n', '<leader>o', ':Neotree  toggle<cr>', { desc = 'Toggle neo-tree' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sF', function() builtin.find_files { hidden = true } end, { desc = '[S]earch [F]iles (hidden)' })
